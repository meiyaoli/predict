...
csv_file = "PBI - redcap/raw/raw_history_of_disease.csv"
...
redcap_df['Text Validation Type OR Show Slider Number'] = np.where(
    df['Data Type'] == 'Date or Date & Time', 'datetime_seconds_ymd', '')
...
redcap_df.to_csv("PBI - redcap/_final/history_of_disease.csv", index=False)
