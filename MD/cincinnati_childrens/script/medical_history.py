...
df = pd.read_excel("MD/cincinnati_childrens/raw_final/raw_medical_history.xlsx")
...
df.to_excel('MD/cincinnati_childrens/_final/medical_history.xlsx', index=False)
