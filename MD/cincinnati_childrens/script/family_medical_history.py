...
df = pd.read_excel("MD/cincinnati_childrens/raw_final/raw_family_medical_history.xlsx")
...
df.to_excel('MD/cincinnati_childrens/_final/family_medical_history.xlsx', index=False)
