...
df = pd.read_csv("csv/genetic_analysis.csv")
...
df.rename(columns={
    ...
    'HGVS Accession number': 'HGVS_ACC',
    ...
    'Does this subject have two or more genetically different sets of cells in their body?': 'MOSAICIAM',
...
df.to_excel('_final/genetic_analysis.xlsx', index=False)
